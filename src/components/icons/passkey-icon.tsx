export function PasskeyIcon({className}: {className?: string}) {
  return (
    <svg className={className} xmlSpace="preserve" viewBox="0 0 216 216" aria-hidden>
      <style>{".st1{fill-rule:evenodd;clip-rule:evenodd;fill:currentColor}"}</style>
      <g id="Isolation_Mode">
        <path
          d="M0 0h216v216H0z"
          style={{
        ...
        />
        <path
          d="M172.41 96.88c0 13.62-8.25 25.23-19.83 29.67l6.58 11.84-9.73 13 9.73 12.71-17.03 23.05v-85.54c4.02 0 7.28-3.41 7.28-7.6 0-4.2-3.26-7.61-7.28-7.61V65.28c16.73 0 30.28 14.15 30.28 31.6z"
          style={{
            fillRule: "evenodd",
            clipRule: "evenodd",
            fill: "currentColor",
        ...
        />
        <path
          d="M120.24 131.43c-9.75-8-16.3-20.3-17.2-34.27H50.8c-10.96 0-19.84 9.01-19.84 20.13v25.17c0 5.56 4.44 10.07 9.92 10.07h69.44c5.48 0 9.92-4.51 9.92-10.07v-11.03z"
          className="st1"
        />
        <path
